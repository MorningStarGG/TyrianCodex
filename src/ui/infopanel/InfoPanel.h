...
// The Info Panel: a Titan/ElvUI-style data-text bar docked to the top or bottom of the screen, with three
// zones (left / center / right). Like the HUD bar, EVERY setting lives in Config (config.info* scalars +
